...
@Singleton
public class GoProjectTypeDescriptionExtension implements ProjectTypeDescriptionExtension {

    @Inject
    public GoProjectTypeDescriptionExtension(ProjectTypeDescriptionRegistry registry) {
    ...
    public List<ProjectType> getProjectTypes() {
        ...
        list.add(new ProjectType(ProjectAttributes.GO_ID, ProjectAttributes.GO_NAME, ProjectAttributes.GO_CATEGORY));
        return list;
    }
