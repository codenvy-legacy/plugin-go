...
@Singleton
public class GoProjectTypeExtension implements ProjectTypeExtension {
    private static final Logger LOG = LoggerFactory.getLogger(GoProjectTypeExtension.class);
    private final ProjectType                      projectType;
    private final ProjectTemplateDescriptionLoader projectTemplateDescriptionLoader;

    @Inject
    public GoProjectTypeExtension(ProjectTypeDescriptionRegistry registry,
        ...
        this.projectType = new ProjectType(ProjectAttributes.GO_ID, ProjectAttributes.GO_NAME, ProjectAttributes.GO_CATEGORY);
    ...
    public List<Attribute> getPredefinedAttributes() {
        ...
        list.add(new Attribute(Constants.LANGUAGE, ProjectAttributes.GO_ID));
        return list;
    }
